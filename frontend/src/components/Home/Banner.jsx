...
const Banner = () => {
  ...
  return (
    <div>
      <div className="relative flex w-full h-[230px] md:h-[350px] lg:h-[550px]">
          ...
          <div className="flex flex-col justify-center gap-3 md:gap-10 lg:gap-20">
            ...
            <div className="flex flex-col self-center justify-center items-center mx sm:flex-row rounded-md sm:border-4 w-[60%] sm:w-full bg-white">
              ...
              <div className="flex justify-between items-center gap-x-8 md:gap-x-4 w-full p-1 sm:px-3 sm:p-2 sm:rounded-r-lg flex-0">
                ...
                <button
                  className="bg-[#15AA6A] text-white px-2 py-[1.5px] sm:px-5 sm:py-1 text-xs lg:text-base rounded sm:rounded-lg flex justify-center items-center"
            ...
            <div {...getRootProps()} className="self-center sm:self-end">
              <input {...getInputProps()} />
              <button
                className="flex flex-row justify-center items-center gap-x-1 sm:gap-x-3 font-semibold bg-[#46d597] opacity-90 sm:bg-opacity-60 w-fit md:px-3 md:py-1 lg:py-4 rounded-lg text-[8px] p-1 px-2"
                onClick={open}
              >
              ...
              <aside className="text-[8px] sm:text-base font-semibold">
                <ul className="text-white sm:text-red-500">
                  {fileRejectionItems}
                </ul>
              </aside>
            </div>
