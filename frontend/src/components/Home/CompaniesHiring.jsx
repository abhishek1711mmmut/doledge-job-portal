...
const CompaniesHiring = () => {
  ...
  return (
    <div className="flex flex-col my-5 md:my-8 lg:my-10 w-[90%] 2xl:w-[90%] mx-auto max-w-[1350px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 my-3 sm:my-10">
        {companies.map((company, index) => (
          <div
            key={index}
            className="flex flex-col gap-y-1 sm:gap-y-3 border-2 border-solid border-black border-opacity-10 rounded-2xl p-1 sm:p-3"
          >
